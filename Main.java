public class Main {
    ...
    public static void main(String[] args){
        ...
        count22OverlapResults();   //askdalsklhglwjhfljehfljwehljewhflkjweowefie0fjewqofjo[iejfoijefo]
        factorsOf10Results();      //hfoueqhfouwehfiuwhfoqhfuqehfpdoufeofuehfoiuwhiofuhweifh
